...
namespace MoencoPOS.Controllers
{
    public class SalesInvoicesController : Controller
    {
        ...
        [Authorize]
        public ActionResult SalesReport(int? branchId, DateTime? fromDate, DateTime? toDate)
        {
            ...
            {
                salesInvoices = _salesInvoiceService.Get(t => t.BranchId == branchId && t.DateSold > fromDate && t.DateSold <= toDate && t.Status == "Paid", null, "SalesLineItems").ToList();
            }
            else if (fromDate != null)
            {
                salesInvoices = _salesInvoiceService.Get(t => t.BranchId == branchId && t.DateSold > fromDate && t.Status == "Paid", null, "SalesLineItems").ToList();
            }
            else
            {
